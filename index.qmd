...
* ¿Cómo varía la masa corporal (body_mass_g) entre las diferentes especies y islas de los pingüinos?
 ...
 Se mantiene casi constante y se evidencia que la especie Gentoo es la que tiene mayor masa en la isla Biscoe de donde es nativa. 
...
Usaría el diagrama de cajas y bigotes porque me permite ver las distribuciones por isla y por especie de pinguino, si el problema tuviera más categorías usaría un histograma.
...
Un gráfico de calor para ver los conteos de las especies en un solo gráfico mostrando cuantos hay en que lugar.
